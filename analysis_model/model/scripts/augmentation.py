...
pre_transformation = weights.transforms()
...
transformation = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=pre_transformation.mean, std=pre_transformation.std)
])
...
print(transformed_image.shape)  # Should print torch.Size([3, 224, 224])
'''
